...
new Vue({
  ...
  data () {
    ...
    return {
      ...
      js_topic: [
        { code: '', name: 'All' },
        { code: 'future-skills', name: 'Future Skills 2030' },
        { code: 'mobility-indicators', name: 'Leading Indicators of Economic and Social Mobility' },
        { code: 'beyond-the-survey', name: 'Beyond The Survey: Innovations in Community Engagement in Times of Crisis' },
        { code: 'community-demand', name: 'Insights into Community Demand in Education' },
        { code: 'ai-ml-assessments', name: 'Innovations in Uses of AI and Machine Learning to Create More Effective, Inexpensive and Inclusive Assessments' },
        { code: 'assessment-challenges', name: 'Understanding the Challenges of Innovating Assessments' },
      ],
      js_region: [
        { code: '', name: 'All' },
